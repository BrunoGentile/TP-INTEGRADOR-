<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AltaMedico.aspx.vb" Inherits="TP_INTEGRADOR.AltaMedico" %>
...
&nbsp;<br />
            ...
            <tr>
                ...
                <td class="auto-style5" colspan="2">
                    <asp:TextBox ID="TextBox6" runat="server" Width="36px"></asp:TextBox>
                    /<asp:TextBox ID="TextBox13" runat="server" Height="16px" Width="57px"></asp:TextBox>
                    /<asp:TextBox ID="TextBox14" runat="server" Height="16px" Width="61px"></asp:TextBox>
                </td>
                <td class="auto-style5"></td>
                <td class="auto-style5"></td>
                <td class="auto-style5"></td>
