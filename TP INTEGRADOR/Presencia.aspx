<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Presencia.aspx.vb" Inherits="TP_INTEGRADOR.Presencia" %>
            ...
            <table class="auto-style1">
                ...
                <tr>
                    <td class="auto-style9">Presentes:
                        <asp:Label ID="lbl1" runat="server" Text="porcentaje"></asp:Label>
                        %</td>
                ...
                <tr>
                    <td class="auto-style8">Ausentes:
                        <asp:Label ID="lbl2" runat="server" Text="porcenteje"></asp:Label>
                        %</td>
                    <td class="auto-style6"></td>
                    <td class="auto-style2"></td>
                    <td class="auto-style2"></td>
